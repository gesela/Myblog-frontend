      ...
      <div className="topRight">
        {user ? (
          <Link className="link" to="/settings">
            <img
              className="topImg"
              src="https://media1.cgtrader.com/variants/DAUf2vuFMWFJCV6cswsEpc8U/40073f86dea5cc27b3e46b911284f10ff35833da74046da55f55f229c8993de7/3.jpg?auto=compress&cs=tinysrgb&dpr=2&w=500"
              alt=""
            />
          </Link>
        ) : (
